...
export default function UnitPage() {
  ...
  const handleSubunitClick = (subunit: Subunit) => {
    ...
    router.push(`/course/${courseId}/unit/${unitId}/subunit/${subunit.sub_unit_id}`)
  }
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <div className="flex items-center gap-3 mb-2">
                              ...
                              <h3 className="text-lg font-semibold text-gray-800">{subunit.sub_unit_name}</h3>
                            </div>
                            <p className="text-gray-600 mb-3">{subunit.sub_unit_description}</p>
